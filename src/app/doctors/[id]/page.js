            ...
            <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        <h2 className="text-sm para text-gray-500 tracking-widest">
                            {doctorsFind.category}
                        </h2>
                        <h1 className="text-gray-900 text-3xl font-medium mb-1 para">
                            {doctorsFind.name}
                        </h1>
                        ...
                        <div className="flex justify-between para mt-5">
                            <p className="font-semibold">Gender</p>
                            <p>{doctorsFind.gender}</p>
                        </div>
                        <div className="flex justify-between para mt-1">
                            <p className="font-semibold">Hospital</p>
                            <p>{doctorsFind.hospital}</p>
                        </div>
                        <div className="flex justify-between para mt-1">
                            <p className="font-semibold">Appointment Time</p>
                            <p>{doctorsFind.appointmentTime}</p>
                        </div>
                        <div className="flex justify-between para mt-1">
                            <p className="font-semibold">Doctor Fees</p>
                            <p>${doctorsFind.fees}</p>
                        </div>
                        <div className="relative">
                            <Button variant="outline" className={"bg-black text-white rounded para text-[12px] font-normal mt-8 w-full"}>
